...
public class RecyclerViewAdapter2 extends RecyclerView.Adapter<RecyclerViewAdapter2.RecyclerViewHolder>{
    private ArrayList<CourseModel2> courseDataArrayList;
    private Context mcontext;



    public RecyclerViewAdapter2(ArrayList<CourseModel2> recyclerDataArrayList) {
        this.courseDataArrayList = recyclerDataArrayList;
        this.mcontext = mcontext;
    }
    public void filterList(ArrayList<CourseModel2> filterlist) {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        CourseModel2 recyclerData = courseDataArrayList.get(position);
        holder.courseTV.setText(recyclerData.getTitle());
        holder.textView1.setText(recyclerData.getTitle1());
        holder.textView2.setImageResource(recyclerData.getTitle2());
