...
public class Newbroadcast extends AppCompatActivity {
    ...
    public void grop(View view) {
        ...
        if (selectedItems.isEmpty()) {
            Toast.makeText(Newbroadcast.this, "At least 1 contact should be selected", Toast.LENGTH_SHORT).show();
        } else {
            Intent intent = new Intent(Newbroadcast.this, cratebroadcast.class);
